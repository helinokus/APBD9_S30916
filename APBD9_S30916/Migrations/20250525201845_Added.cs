    ...
    public partial class Added : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "anna.nowak@clinic.pl", "Anna", "Nowak" });

            migrationBuilder.InsertData(
                table: "Medicament",
                columns: new[] { "Id", "Description", "Name", "Type" },
                values: new object[] { 1, "Pain relief", "Ibuprofen", "Tablet" });

            migrationBuilder.InsertData(
                table: "Patient",
                columns: new[] { "Id", "BirthDate", "FirstName", "LastName" },
                values: new object[] { 1, new DateOnly(1980, 5, 12), "Jan", "Kowalski" });

            migrationBuilder.InsertData(
                table: "Prescription",
                columns: new[] { "IdPrescription", "Date", "DueDate", "IdDoctor", "IdPatient" },
                values: new object[] { 1, new DateOnly(2024, 5, 1), new DateOnly(2024, 6, 1), 1, 1 });
